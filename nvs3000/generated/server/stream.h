...
#ifndef ____generated_server_stream_h__
#define ____generated_server_stream_h__
...
template<>
struct StreamableTraits< ::Media::Catalog>
{
    static const StreamHelperCategory helper = StreamHelperCategoryStruct;
...
template<class S>
struct StreamWriter< ::Media::Catalog, S>
{
    static void write(S* __os, const ::Media::Catalog& v)
    {
        __os->write(v.id);
        __os->write(v.name);
        __os->write(v.sdk);
...
template<class S>
struct StreamReader< ::Media::Catalog, S>
{
    static void read(S* __is, ::Media::Catalog& v)
    {
        __is->read(v.id);
        __is->read(v.name);
        __is->read(v.sdk);
...
public:
    ...
    virtual void ice_response(const ::Media::StreamPtr&) = 0;
};
...
public:
    ...
    virtual void ice_response(const ::Media::StreamPtr&);
...
public:
    ...
    void openRealStream(const ::Media::Catalog& __p_ctg, ::Media::StreamPtr& __p_stm)
    {
        openRealStream(__p_ctg, __p_stm, 0);
    }
    void openRealStream(const ::Media::Catalog& __p_ctg, ::Media::StreamPtr& __p_stm, const ::Ice::Context& __ctx)
    {
        openRealStream(__p_ctg, __p_stm, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::IceInternal::Function<void (const ::Media::StreamPtr&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_openRealStream(__p_ctg, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_openRealStream(__p_ctg, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Media::StreamPtr&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_openRealStream(__p_ctg, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Media::StreamPtr&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog& __p_ctg)
    {
        return begin_openRealStream(__p_ctg, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::Context& __ctx)
    {
        return begin_openRealStream(__p_ctg, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_openRealStream(__p_ctg, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_openRealStream(__p_ctg, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Media::Callback_Stream_openRealStreamPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_openRealStream(__p_ctg, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog& __p_ctg, const ::Ice::Context& __ctx, const ::Media::Callback_Stream_openRealStreamPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_openRealStream(__p_ctg, &__ctx, __del, __cookie);
    }

    void end_openRealStream(::Media::StreamPtr& __p_stm, const ::Ice::AsyncResultPtr&);
    
private:

    void openRealStream(const ::Media::Catalog&, ::Media::StreamPtr&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_openRealStream(const ::Media::Catalog&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void openRealStream_async(const ::Media::AMD_Stream_openRealStreamPtr&, const ::Media::Catalog&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    typedef void (T::*Response)(const ::Media::StreamPtr&);
...
newCallback_Stream_openRealStream(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::Media::StreamPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Stream_openRealStream<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Stream_openRealStreamPtr
newCallback_Stream_openRealStream(T* instance, void (T::*cb)(const ::Media::StreamPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Stream_openRealStream<T>(instance, cb, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Response)(const ::Media::StreamPtr&, const CT&);
...
newCallback_Stream_openRealStream(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::Media::StreamPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Stream_openRealStream<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Stream_openRealStreamPtr
newCallback_Stream_openRealStream(T* instance, void (T::*cb)(const ::Media::StreamPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Stream_openRealStream<T, CT>(instance, cb, excb, sentcb);
}
