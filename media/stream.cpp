...
Media::Stream::_iceD_getStreamStatic(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    this->getStreamStatic(::std::move(iceP_id), iceP_statics, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(iceP_statics);
    inS.endWriteParams();
    return true;
}
/// \endcond
...
Media::Stream::_iceD_getRecordFiles(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
    ::std::string iceP_start;
    ::std::string iceP_end;
    istr->readAll(iceP_start, iceP_end);
    inS.endReadParams();
    ::std::string iceP_files;
    this->getRecordFiles(::std::move(iceP_start), ::std::move(iceP_end), iceP_files, current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(iceP_files);
    inS.endWriteParams();
    return true;
}
/// \endcond
...
Media::Stream::_iceD_openVodStream(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    this->openVodStream(::std::move(iceP_ctg), iceP_stm, current);
    auto ostr = inS.startWriteParams();
...
Media::Stream::_iceD_closeVodStream(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readAll(iceP_id, iceP_callid);
    inS.endReadParams();
    this->closeVodStream(::std::move(iceP_id), ::std::move(iceP_callid), current);
...
Media::Stream::_iceD_controlVodStream(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    ::std::string iceP_callid;
    ::std::string iceP_cmd;
    istr->readAll(iceP_id, iceP_callid, iceP_cmd);
    inS.endReadParams();
    this->controlVodStream(::std::move(iceP_id), ::std::move(iceP_callid), ::std::move(iceP_cmd), current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
...
/// \cond INTERNAL
void
Media::StreamPrx::_iceI_getRecordFiles(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::string>>& outAsync, const ::std::string& iceP_start, const ::std::string& iceP_end, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_Media_Stream_getRecordFiles_name);
    outAsync->invoke(iceC_Media_Stream_getRecordFiles_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_start, iceP_end);
        },
        nullptr);
}
/// \endcond
...
/// \cond INTERNAL
void
Media::StreamPrx::_iceI_openVodStream(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<RealStreamRespParam>>& outAsync, const RealStreamReqParam& iceP_ctg, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Media::StreamPrx::_iceI_closeVodStream(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::string& iceP_id, const ::std::string& iceP_callid, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Media::StreamPrx::_iceI_controlVodStream(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::string& iceP_id, const ::std::string& iceP_callid, const ::std::string& iceP_cmd, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_Media_Stream_controlVodStream_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
            ostr->writeAll(iceP_id, iceP_callid, iceP_cmd);
        },
        nullptr);
}
/// \endcond
...
void
IceProxy::Media::Stream::end_getStreamStatic(::Media::StreamStatic& iceP_statics, const ::Ice::AsyncResultPtr& result)
{
    ...
    ::Ice::InputStream* istr = result->_startReadParams();
    istr->read(iceP_statics);
    result->_endReadParams();
}

void IceProxy::Media::Stream::_iceI_end_getStreamStatic(::Media::StreamStatic& iceP_statics, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Media_Stream_getStreamStatic_name);
    if(!result->_waitForResponse())
    {
...
::Ice::AsyncResultPtr
IceProxy::Media::Stream::_iceI_begin_getRecordFiles(const ::std::string& iceP_start, const ::std::string& iceP_end, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Media_Stream_getRecordFiles_name, sync);
...
void
IceProxy::Media::Stream::end_getRecordFiles(::std::string& iceP_files, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Media_Stream_getRecordFiles_name);
    if(!result->_waitForResponse())
    {
        try
        {
    ...
    ::Ice::InputStream* istr = result->_startReadParams();
    istr->read(iceP_files);
    result->_endReadParams();
}

void IceProxy::Media::Stream::_iceI_end_getRecordFiles(::std::string& iceP_files, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Media_Stream_getRecordFiles_name);
    if(!result->_waitForResponse())
    {
...
::Ice::AsyncResultPtr
IceProxy::Media::Stream::_iceI_begin_openVodStream(const ::Media::RealStreamReqParam& iceP_ctg, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
void
IceProxy::Media::Stream::end_openVodStream(::Media::RealStreamRespParam& iceP_stm, const ::Ice::AsyncResultPtr& result)
{
...
void IceProxy::Media::Stream::_iceI_end_openVodStream(::Media::RealStreamRespParam& iceP_stm, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Media_Stream_openVodStream_name);
    if(!result->_waitForResponse())
    {
...
::Ice::AsyncResultPtr
IceProxy::Media::Stream::_iceI_begin_closeVodStream(const ::std::string& iceP_id, const ::std::string& iceP_callid, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
::Ice::AsyncResultPtr
IceProxy::Media::Stream::_iceI_begin_controlVodStream(const ::std::string& iceP_id, const ::std::string& iceP_callid, const ::std::string& iceP_cmd, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
Media::Stream::_iceD_getStreamStatic(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    StreamStatic iceP_statics;
    this->getStreamStatic(iceP_id, iceP_statics, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(iceP_statics);
    inS.endWriteParams();
    return true;
}
/// \endcond
...
Media::Stream::_iceD_getRecordFiles(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    ::std::string iceP_files;
    this->getRecordFiles(iceP_start, iceP_end, iceP_files, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(iceP_files);
    inS.endWriteParams();
    return true;
}
/// \endcond
...
Media::Stream::_iceD_openVodStream(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    RealStreamRespParam iceP_stm;
    this->openVodStream(iceP_ctg, iceP_stm, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(iceP_stm);
    inS.endWriteParams();
    return true;
...
Media::Stream::_iceD_closeVodStream(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_callid);
    inS.endReadParams();
    this->closeVodStream(iceP_id, iceP_callid, current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
...
Media::Stream::_iceD_controlVodStream(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_cmd);
    inS.endReadParams();
    this->controlVodStream(iceP_id, iceP_callid, iceP_cmd, current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond
