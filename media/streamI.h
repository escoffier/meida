...
public:
	StreamI();
	~StreamI();
	 virtual void openRealStreamAsync(::Media::RealStreamReqParam, ::std::function<void(bool returnValue, const ::Media::RealStreamRespParam&)>, 
	 ...
	 virtual void getRecordFiles(::std::string, ::std::string, std::string& files, const ::Ice::Current&) {}
