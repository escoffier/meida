...
/// \cond INTERNAL
static OpenStreamException _iceS_OpenStreamException_init;
/// \endcond
...
struct RealStreamReqParam
{
    ...
    {
        return std::tie(id, callid, destip, destport, ssrc, pt);
    }
};
...
struct StreamStatic
{
    ...
    {
        return std::tie(busynode, freenode);
    }
};
...
public:
    ...
    virtual void getStreamStatic(::std::string id, StreamStatic& statics, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getStreamStatic(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void getRecordFiles(::std::string start, ::std::string end, ::std::string& files, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getRecordFiles(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void openVodStream(RealStreamReqParam ctg, RealStreamRespParam& stm, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_openVodStream(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void closeVodStream(::std::string id, ::std::string callid, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_closeVodStream(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void controlVodStream(::std::string id, ::std::string callid, ::std::string cmd, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    void getStreamStatic(const ::std::string& id, StreamStatic& statics, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        statics = _makePromiseOutgoing<StreamStatic>(true, this, &StreamPrx::_iceI_getStreamStatic, id, context).get();
    }
    ...
    void getRecordFiles(const ::std::string& start, const ::std::string& end, ::std::string& files, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        files = _makePromiseOutgoing<::std::string>(true, this, &StreamPrx::_iceI_getRecordFiles, start, end, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getRecordFilesAsync(const ::std::string& start, const ::std::string& end, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::std::string>>().get_future())
    {
        return _makePromiseOutgoing<::std::string, P>(false, this, &StreamPrx::_iceI_getRecordFiles, start, end, context);
    }

    ::std::function<void()>
    getRecordFilesAsync(const ::std::string& start, const ::std::string& end,
                        ::std::function<void(::std::string)> response,
                        ::std::function<void(::std::exception_ptr)> ex = nullptr,
                        ::std::function<void(bool)> sent = nullptr,
                        const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::std::string>(response, ex, sent, this, &StreamPrx::_iceI_getRecordFiles, start, end, context);
    }

    /// \cond INTERNAL
    void _iceI_getRecordFiles(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::string>>&, const ::std::string&, const ::std::string&, const ::Ice::Context&);
    /// \endcond

    void openVodStream(const RealStreamReqParam& ctg, RealStreamRespParam& stm, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        stm = _makePromiseOutgoing<RealStreamRespParam>(true, this, &StreamPrx::_iceI_openVodStream, ctg, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto openVodStreamAsync(const RealStreamReqParam& ctg, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<RealStreamRespParam>>().get_future())
    {
        return _makePromiseOutgoing<RealStreamRespParam, P>(false, this, &StreamPrx::_iceI_openVodStream, ctg, context);
    }

    ::std::function<void()>
    openVodStreamAsync(const RealStreamReqParam& ctg,
                       ::std::function<void(RealStreamRespParam)> response,
                       ::std::function<void(::std::exception_ptr)> ex = nullptr,
                       ::std::function<void(bool)> sent = nullptr,
                       const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<RealStreamRespParam>(response, ex, sent, this, &StreamPrx::_iceI_openVodStream, ctg, context);
    }
    ...
    void closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &StreamPrx::_iceI_closeVodStream, id, callid, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto closeVodStreamAsync(const ::std::string& id, const ::std::string& callid, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &StreamPrx::_iceI_closeVodStream, id, callid, context);
    }

    ::std::function<void()>
    closeVodStreamAsync(const ::std::string& id, const ::std::string& callid,
                        ::std::function<void()> response,
                        ::std::function<void(::std::exception_ptr)> ex = nullptr,
                        ::std::function<void(bool)> sent = nullptr,
                        const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &StreamPrx::_iceI_closeVodStream, id, callid, context);
    }
    ...
    void controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &StreamPrx::_iceI_controlVodStream, id, callid, cmd, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto controlVodStreamAsync(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &StreamPrx::_iceI_controlVodStream, id, callid, cmd, context);
    }

    ::std::function<void()>
    controlVodStreamAsync(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd,
                          ::std::function<void()> response,
                          ::std::function<void(::std::exception_ptr)> ex = nullptr,
                          ::std::function<void(bool)> sent = nullptr,
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &StreamPrx::_iceI_controlVodStream, id, callid, cmd, context);
    }
...
struct StreamReader<::Media::RealStreamReqParam, S>
{
    ...
    {
        istr->readAll(v.id, v.callid, v.destip, v.destport, v.ssrc, v.pt);
    }
};
...
struct StreamReader<::Media::StreamStatic, S>
{
    ...
    {
        istr->readAll(v.busynode, v.freenode);
    }
};
...
public:
    ...
    void getStreamStatic(const ::std::string& id, ::Media::StreamStatic& statics, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_getStreamStatic(statics, _iceI_begin_getStreamStatic(id, context, ::IceInternal::dummyCallback, 0, true));
    }
    ...
    void end_getStreamStatic(::Media::StreamStatic& statics, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getStreamStatic(::Media::StreamStatic& iceP_statics, const ::Ice::AsyncResultPtr&);
    /// \endcond
...
public:
    ...
    void getRecordFiles(const ::std::string& start, const ::std::string& end, ::std::string& files, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_getRecordFiles(files, _iceI_begin_getRecordFiles(start, end, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getRecordFiles(const ::std::string& start, const ::std::string& end, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getRecordFiles(start, end, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getRecordFiles(const ::std::string& start, const ::std::string& end, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getRecordFiles(start, end, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getRecordFiles(const ::std::string& start, const ::std::string& end, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getRecordFiles(start, end, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getRecordFiles(const ::std::string& start, const ::std::string& end, const ::Media::Callback_Stream_getRecordFilesPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getRecordFiles(start, end, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getRecordFiles(const ::std::string& start, const ::std::string& end, const ::Ice::Context& context, const ::Media::Callback_Stream_getRecordFilesPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getRecordFiles(start, end, context, cb, cookie);
    }

    void end_getRecordFiles(::std::string& files, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getRecordFiles(::std::string& iceP_files, const ::Ice::AsyncResultPtr&);
    /// \endcond
...
public:
    ...
    void openVodStream(const ::Media::RealStreamReqParam& ctg, ::Media::RealStreamRespParam& stm, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_openVodStream(stm, _iceI_begin_openVodStream(ctg, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_openVodStream(const ::Media::RealStreamReqParam& ctg, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_openVodStream(ctg, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_openVodStream(const ::Media::RealStreamReqParam& ctg, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_openVodStream(ctg, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_openVodStream(const ::Media::RealStreamReqParam& ctg, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_openVodStream(ctg, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_openVodStream(const ::Media::RealStreamReqParam& ctg, const ::Media::Callback_Stream_openVodStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_openVodStream(ctg, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_openVodStream(const ::Media::RealStreamReqParam& ctg, const ::Ice::Context& context, const ::Media::Callback_Stream_openVodStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_openVodStream(ctg, context, cb, cookie);
    }

    void end_openVodStream(::Media::RealStreamRespParam& stm, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_openVodStream(::Media::RealStreamRespParam& iceP_stm, const ::Ice::AsyncResultPtr&);
    /// \endcond
...
public:
    ...
    void closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_closeVodStream(_iceI_begin_closeVodStream(id, callid, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_closeVodStream(id, callid, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeVodStream(id, callid, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeVodStream(id, callid, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Media::Callback_Stream_closeVodStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeVodStream(id, callid, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::Context& context, const ::Media::Callback_Stream_closeVodStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_closeVodStream(id, callid, context, cb, cookie);
    }
...
public:
    ...
    void controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_controlVodStream(_iceI_begin_controlVodStream(id, callid, cmd, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_controlVodStream(id, callid, cmd, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_controlVodStream(id, callid, cmd, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_controlVodStream(id, callid, cmd, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Media::Callback_Stream_controlVodStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_controlVodStream(id, callid, cmd, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Context& context, const ::Media::Callback_Stream_controlVodStreamPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_controlVodStream(id, callid, cmd, context, cb, cookie);
    }
...
public:
    ...
    virtual void getStreamStatic(const ::std::string& id, StreamStatic& statics, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getStreamStatic(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void getRecordFiles(const ::std::string& start, const ::std::string& end, ::std::string& files, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getRecordFiles(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void openVodStream(const RealStreamReqParam& ctg, RealStreamRespParam& stm, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_openVodStream(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void closeVodStream(const ::std::string& id, const ::std::string& callid, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_closeVodStream(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual void controlVodStream(const ::std::string& id, const ::std::string& callid, const ::std::string& cmd, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_controlVodStream(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    {
        StreamPrx proxy = StreamPrx::uncheckedCast(result->getProxy());
        StreamStatic iceP_statics;
        try
        {
            proxy->end_getStreamStatic(iceP_statics, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
        ...
        if(_response)
        {
            (::IceInternal::CallbackNC<T>::_callback.get()->*_response)(iceP_statics);
        }
    }
    /// \endcond
...
public:
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        if(_response)
        {
            (::IceInternal::Callback<T, CT>::_callback.get()->*_response)(iceP_statics, CT::dynamicCast(result->getCookie()));
        }
    }
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_Stream_getRecordFiles : public Callback_Stream_getRecordFiles_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    {
        StreamPrx proxy = StreamPrx::uncheckedCast(result->getProxy());
        ::std::string iceP_files;
        try
        {
            proxy->end_getRecordFiles(iceP_files, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
        ...
        if(_response)
        {
            (::IceInternal::CallbackNC<T>::_callback.get()->*_response)(iceP_files);
        }
    }
    /// \endcond
...
newCallback_Stream_getRecordFiles(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
 ...
 */
template<class T> Callback_Stream_getRecordFilesPtr
newCallback_Stream_getRecordFiles(T* instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Stream_getRecordFiles<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_Stream_getRecordFiles : public Callback_Stream_getRecordFiles_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        if(_response)
        {
            (::IceInternal::Callback<T, CT>::_callback.get()->*_response)(iceP_files, CT::dynamicCast(result->getCookie()));
        }
    }
    /// \endcond
...
newCallback_Stream_getRecordFiles(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
 ...
 */
template<class T, typename CT> Callback_Stream_getRecordFilesPtr
newCallback_Stream_getRecordFiles(T* instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Stream_getRecordFiles<T, CT>(instance, cb, excb, sentcb);
}
...
public:
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            proxy->end_openVodStream(iceP_stm, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
